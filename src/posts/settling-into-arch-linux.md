---
title: 'Settling into Arch Linux'
...
My journey with computers started in an atypical way. As a kid, I was
...
and learned basic GNOME on Linux.

Around the age of 14, I had saved enough money to get my first gaming PC with
...
cut off the internet, leading me to spoof my MAC address to keep playing.

## University and Linux

At 18, preparing for university, I picked a first-generation MateBook X Pro.
...
hassles involved with getting it to function correctly.

During university, I discovered a passion for Linux. I worked my entire degree
...
despite having bash on every single machine I would want to run them on.

## Making my Environment Bespoke

In 2022, I picked up the MacBook M1 Pro and delved deeper into tools like
...
ensure that I can use normal keyboards and my laptop keyboard when necessary.

I then got into Aerospace, a window manager for MacOS, with Sketchybar,
...
At some point, I got fed up enough with the OS to leave it behind.

In recent years, I've transitioned from the M1 MacBook Pro to a Framework
...
thrown a base model M4 mini into my homelab.

## So, what am I running on the framework?

I chose Arch Linux. Not for the hype reasons that the community has. I'm not
...
with a handful of supplementary ones:

- Terminal Emulator: Ghostty
- Browser: Zen (tried a ton, this is the one I'm happiest wiht for now)
- Notes: Obsidian
- Screen Capture: Obs
- RDP/VNC Client: Remmina
- And some basic office and media applications that you'd expect on most systems

I chose Arch because it allows me to install exactly what I want on my system.
...
secure boot, creating a user, then running a single script.
