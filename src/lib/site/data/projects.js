...
export const PROJECTS = [
  {
    links: [
      { label: "pi-tai", href: "https://github.com/xavierchanth/pi-tai" },
    ],
    context: "Personal",
  ...
  {
    links: [
      { label: "Swapper", href: "https://github.com/xavierchanth/swapper" },
    ],
    context: "Personal",
    description:
      "A native macOS utility for swapping windows between dual monitors.",
  },
  {
    links: [
      {
