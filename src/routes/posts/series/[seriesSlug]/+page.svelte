<script>
	...
	const description = $derived(`All posts in the ${data.series.label} series. ${BLOG_DESCRIPTION}`);
...
<div class="site-shell">
  ...
  -->
	<Section id="series" title="In this series">
		<PostList posts={data.posts} taxonomy excludeSeriesSlug={data.series.slug} />
	</Section>
</div>
