...
<div class="site-shell">
	<div class="site-intro">
		...
		<div class="site-intro-body">
			<p class="site-lede site-muted">
				Everything I have published, newest first. Mostly notes on how software gets designed,
	...
	<Section id="archive" title="All posts">
		...
		<LinkRow links={archiveLinks} class="site-section-footer" label="More writing" />
	</Section>
