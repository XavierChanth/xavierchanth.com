...
<div class="site-shell">
	<div class="site-intro">
		...
		<div class="site-intro-body">
			<p>
				...
				>, a startup working on solving problems in the operational assurance space. I love all
				kinds of software and have spent time deepening my knowledge across full-stack development,
				systems programming, and data science and machine learning. I write about how software is
	...
	<Section id="writing" title="Writing">
		...
		<LinkRow links={writingLinks} class="site-section-footer" label="More writing" />
	</Section>
	...
	<Section id="colophon" title="Colophon">
		<div class="site-colophon site-small site-muted site-section-footer">
			...
			<p>
				...
				<a href={COLOPHON_DOTFILES.href} target="_blank" rel="noopener noreferrer">GitHub</a>. I
				maintained them with a massive handwritten posix shell harness until agents got good enough
				to rewrite it all in nix.
			</p>
		</div>
	</Section>
</div>
