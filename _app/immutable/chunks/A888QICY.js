...
AI mistakes are a form of technical debt, and we probably shouldn’t be starting new projects by injecting technical debt on day one.</p> <h2>Recap of my AI Greenfield Development Workflow</h2> <ul><li><strong>Capture</strong>: Get the raw shape of the problem out of your head first. Let the ideas be messy, then use AI to organize them into a coherent design doc draft.</li> <li><strong>Refine</strong>: Pull in a more powerful model to review, refine, and finalize the design document.</li> <li><strong>Develop</strong>: Bring the design document into the codebase and break it down into sizeable chunks.</li> <li><strong>Review</strong>: The better you are at catching mistakes now, the happier you will be later.</li></ul> <h2>Takeaways</h2> <p>When something has been vibe-coded, it’s usually noticeable.
