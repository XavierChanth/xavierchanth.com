...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">"__main__"</span><span class="token punctuation">:</span>
    app<span class="token punctuation">.</span>run<span class="token punctuation">(</span><span class="token punctuation">)</span></code>`),s(i);var l=a(i,16),y=n(l);e(y,()=>'<code class="language-sh">uv run marimo new <span class="token string">"write a fibonacci visual"</span></code>'),s(l);var r=a(l,4),f=n(r);e(f,()=>`<code class="language-sh"><span class="token comment"># /// script</span>
