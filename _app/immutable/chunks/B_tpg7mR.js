...
echo 'formats = "</span>ipynb,py:percent<span class="token string">"' >"</span><span class="token variable">$script_dir</span>/jupytext.toml"</code>`),s(t);var o=a(t,4),k=n(o);e(k,()=>`<code class="language-sh"><span class="token shebang important">#!/usr/bin/env bash</span>
...
uv run marimo edit notebooks <span class="token parameter variable">--watch</span></code>`),s(h),x(10),I(d,u)}export{Q as default,T as metadata};
